        ...
        <div>
          <select
            :class="{
              ...
              'border border-gray-300 rounded-md px-2 py-2.5 focus:outline-none focus:ring-2 focus:ring-shopeeOrange/90 hover:bg-shopeeOrange/90 cursor-pointer hover:text-white text-gray-900':
                !isActiveSortBy(sortProductBy.price)
            }"
